 ...
 */
    ...
    public void test() {
        ...
        spec03.pathParams("parametre1","create");
         ...
         // post request yaprken biz body gondermek zorundayiz , testdata classinda olusturdugumuz request
        // body i burda cagiriyoruz
    ...
    // de serialization yonteminde map a atayacagiz
