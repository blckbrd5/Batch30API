 ...
 */
    ...
    public  void test () {
       ...
       List<Integer> idList = jsonPath.getList("data.findAll{it.id>10}.id");
        ...
        //Assert.assertEquals((Integer)23,yasListesi.get(yasListesi.size() - 1));  veya actual i da (int) yapabiliriz typeCasting yaptik
      ...
      // maaslar  List <Integer> salaryList1=jsonPath.getList("data.findAll{it.employee_salary>350000}.employee_salary");

        System.out.println(salaryList);
       // maaslar listesi  System.out.println(salaryList1);
